...
// Class to record the differnt type of prevalence calculated at one output time
// point
...
public:
  RecordedPrevalence()
      : MF(0.0), IC(0.0), WC(0.0), MFRestrictedAge(0.0), ICRestrictedAge(0.0),
        WCRestrictedAge(0.0) {};
  RecordedPrevalence(int size)
      : MF(0.0), IC(0.0), WC(0.0), MFRestrictedAge(0.0), ICRestrictedAge(0.0),
        WCRestrictedAge(0.0) {
