...
public:
    ...
    double getPopSize() ;
    int PreTASSurvey(Scenario& sc, int forPreTass, int t, int baseYear, int rep,  std::string folderName);
    int TASSurvey(Scenario& sc, int forTass, int t, int baseYear, int rep,  std::string folderName);
    ...
    double getMFPrev(Scenario& sc, int forPreTass, int t, int baseYear, int rep, int sampleSize, std::string folderName);
    bool test_for_infection(bool is_infected, float ICsensitivity, float ICspecificity);
    void getIncidence(Scenario& sc,  int t, int baseYear, int rep,  std::string folderName);
    ...
    double getICPrev(Scenario& sc, int forTass, int t, int baseYear, int rep,  std::string folderName);
    ...
    void ApplyTreatmentUpdated(MDAEvent* mda,  Worm& worms, Scenario& sc, int t, int baseYear, int rep, int DoMDA, int outputEndgame, std::string folderName);
