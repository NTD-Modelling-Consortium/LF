...
public:
  ...
  void createScenarios(TiXmlElement *xmlListOfScenarios,
  ...
  std::string getOutputtMethod() const { return outputMethod; }

  int getExtraMaxAge() const { return extraMaxAge; }

  int getExtraMinAge() const { return extraMinAge; }
